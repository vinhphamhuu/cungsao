...
import {SaoChart} from './components/sao-chart'
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <SaoChart color="#2563eb" data={stats.charts.male} title="Thống kê Sao (Nam)" />
        <SaoChart color="#e11d48" data={stats.charts.female} title="Thống kê Sao (Nữ)" />
      </div>
    </div>
  )
}
