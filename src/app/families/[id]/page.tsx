    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Đại diện: <span className="font-semibold text-foreground">{family.representative?.fullName || "Chưa có"}</span> • {family.area?.name} • {family.group?.name}
                    </p>
            ...
            <Card>
                ...
                <CardContent>
                    <MemberList members={family.members} familyId={family.id} />
                </CardContent>
            </Card>
        </div>
    )
